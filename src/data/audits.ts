...
/** Auditeurs connus pour les filtres / stats (libellés = champ `auditeur` des audits). */
export interface AuditeurRef {
  nom: string;
}

export const auditeursConnus: AuditeurRef[] = [
  { nom: "Cédric MALZAT" },
...
/** Ordre calendaire (libellés alignés sur `toLocaleString('fr-FR', { month: 'long' })` capitalisé). */
export const MOIS_ORDRE = [
  "Janvier",
  "Février",
  "Mars",
  "Avril",
...
export const initialAudits: Audit[] = [
  ...
  { id: genId(), date: "2026-02-03", partenaire: "Amelie GONÇALVES", lieu: "Chambourcy", auditeur: "Cédric", typeEvenement: "Club Affaires", note: 5.8, moisVersement: "Février", statut: "OK" },
  ...
  { id: genId(), date: "2026-02-17", partenaire: "Stella MASSON", lieu: "Maisons-Laffitte", auditeur: "Cédric", typeEvenement: "Club Affaires", note: 0.0, moisVersement: "Mars", statut: "OK" },
  ...
  { id: genId(), date: "2026-03-06", partenaire: "François BOUDALIEZ", lieu: "Lille", auditeur: "Cédric", typeEvenement: "RD Présentiel", note: 7.9, moisVersement: "Mars", statut: "OK" },
  { id: genId(), date: "2026-03-06", partenaire: "Bruno COCHEN", lieu: "", auditeur: "Geoffroy", typeEvenement: "RD Présentiel", note: 7.9, moisVersement: "Mars", statut: "OK" },
