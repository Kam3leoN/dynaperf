...
/** Diamètre du cercle initial = hauteur du rail (32px) — Material 3 : morphing circulaire → pilule. */
...
function RailIconPill({
  ...
  return (
    ...
    >
      ...
      {/* Indicateur sélection : expansion depuis un cercle (ø = hauteur) centré, sans translation entre items */}
      <motion.span
        aria-hidden
...
/**
 * Rail navigation M3 expressive : indicateur sélection (pilule) par entrée — expansion locale
 * depuis un cercle ø = hauteur (Material motion), sans translation partagée entre items.
 */
