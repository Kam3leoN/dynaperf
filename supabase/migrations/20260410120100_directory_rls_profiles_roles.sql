...
DROP POLICY IF EXISTS "Authenticated can read all user_roles for directory" ON public.user_roles;
...
DROP POLICY IF EXISTS "Authenticated can read all profiles for directory" ON public.profiles;
